...
/**
 * Mendapatkan payload sesi terverifikasi langsung dari objek Request / NextRequest
 */
...
/**
 * Menghapus cookie sesi login pada objek NextResponse
 */
export function deleteSessionCookie(response) {
